        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsurarioId = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cartoes", x => x.CartaoId);
                    table.ForeignKey(
                        name: "FK_Cartoes_Usuarios_UsurarioId",
                        column: x => x.UsurarioId,
                        principalTable: "Usuarios",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "8a3949c7-0cf2-49c3-8c0c-9ea0b89f3b69", "748cb2da-e63f-417d-aa69-1afc6aaab526", "Administrador do sistema", "Administrador", "ADMINSISTRADOR" },
                    { "359b7853-e5b3-44c0-af1b-35fbd60acacc", "8dfd3111-3a31-4aa2-a531-d212fb9fabe9", "Usuario do sistema", "Usuario", "USUARIO" }
                });
